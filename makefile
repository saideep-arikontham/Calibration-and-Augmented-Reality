...
vidDisplay: $(SRCDIR)/vidDisplay.o $(SRCDIR)/utils.o
	$(CC) $^ -o $(BINDIR)/$@ $(LDFLAGS) $(LDLIBS)

$(SRCDIR)/vidDisplay.o: $(SRCDIR)/vidDisplay.cpp $(SRCDIR)/utils.h
	$(CC) $(CXXFLAGS) -c $< -o $@

feature: $(SRCDIR)/feature.o $(SRCDIR)/utils.o
	$(CC) $^ -o $(BINDIR)/$@ $(LDFLAGS) $(LDLIBS)

$(SRCDIR)/feature.o: $(SRCDIR)/feature.cpp $(SRCDIR)/utils.h
	$(CC) $(CXXFLAGS) -c $< -o $@
...
clean:
    ...
    rm -f $(IMGDIR)/calibration_image_*.jpg